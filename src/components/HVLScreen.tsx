    ...
    songAnnotations: [
      {
        ...
        startTime: 1.10,
        explanation: "“Intenpol” là track thứ 16, đóng vai trò như một interlude nối tiếp các ca khúc trong [HVL] (2026). Qua ca khúc, MCK phản hồi một cách châm biếm trước những ồn ào truyền thông và màn so sánh kéo dài giữa anh với [HIEUTHUHAI]. Những tranh luận này từng đạt đỉnh sau khi MCK giành giải Album của năm tại [WeChoice Awards 2023] với [99%], cũng như khi [“thap drill tu do”] vươn lên vị trí số một trên bảng xếp hạng thịnh hành của YouTube Việt Nam, vượt qua [“Nước Mắt Cá Sấu”] của HIEUTHUHAI.\n\nĐiểm đặc biệt nhất của track nằm ở việc MCK sử dụng các đoạn âm thanh thực tế được lấy từ truyền thông và những sự kiện công chúng. Đáng chú ý, nam rapper từng hé lộ quá trình chuẩn bị cho phần sampling này từ khá sớm. Ngày 20/8/2025, MCK đăng lời kêu gọi trên [Broadcast Channel] Instagram, đề nghị người hâm mộ gửi các video edit, bản thu âm chất lượng cao từ khoảnh khắc xướng tên nhận giải tại [WeChoice Awards], cùng “cả phốt phủng các kiểu luôn”.\n\nViệc chủ động thu thập và tái sử dụng những tư liệu xoay quanh chính mình biến “Intenpol” thành một màn “tự đào phốt” đầy chủ ý. MCK không né tránh các tranh cãi, mà trực tiếp chuyển hóa chúng thành chất liệu âm nhạc mang màu sắc giễu nhại. Đồng thời, động thái này cũng cho thấy HVL đã được chuẩn bị theo một định hướng dài hơi, ít nhất từ giữa năm 2025, với sự đầu tư rõ rệt vào cách xây dựng bối cảnh và mạch nội dung cho toàn bộ album.",
      },
    ],
  },
  {
