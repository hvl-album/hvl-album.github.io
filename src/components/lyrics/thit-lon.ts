...
export const thitLonLyrics: LyricsTrack = {
  lyrics: String.raw`
...
[0,
  ...
  50.06, 52.92, 55.98, 59.1, 60.76, 63.66, 66.74, 70.24, 71.8, 73.02, 74.58, 76.2,
  ...
  165, 166.76, 167.1, 168.82, 171.82, 174.82, 178.16, 180.88, 183.86, 186.7, 190.22, 195.1
],
} as const;
